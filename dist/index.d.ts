...
export type ServerAppointmentSessionStatus = "SCHEDULED" | "IN_PROGRESS" | "COMPLETED";
export type ServerAppointmentSessionStep = "date" | "service" | "professional" | "prehour" | "hour" | "name" | "confirmar";
